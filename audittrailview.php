...
class caudittrail_view extends caudittrail {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_audittrail\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_audittrail',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.faudittrailview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<?php if (!$audittrail_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="faudittrailview" id="faudittrailview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="audittrail">
<table class="ewGrid"><tr><td>
<table id="tbl_audittrailview" class="table table-bordered table-striped">
