...
define("EW_PROJECT_NAME", "FactoryVisit", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{C2A46AD1-29DD-4049-B347-17989E75216E}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Y7lW2d3xGLmsgSU7', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/factoryvisit.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", 'skbintranetsvr', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'root', TRUE);
define("EW_CONN_PASS", '', TRUE);
define("EW_CONN_DB", 'fv', TRUE);
...
define("EW_ADMIN_PASSWORD", "Adm!n", TRUE); // Administrator password
...
define("EW_USER_NAME_FILTER", "(`userid` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`site` = '%u')",  TRUE);
