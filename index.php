...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'pengunjung'))
		$this->Page_Terminate("pengunjunglist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'typepengunjung'))
			$this->Page_Terminate("typepengunjunglist.php");
		if ($Security->AllowList(CurrentProjectID() . 'kota'))
			$this->Page_Terminate("kotalist.php");
		if ($Security->AllowList(CurrentProjectID() . 'provinsi'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'tamuvip'))
			$this->Page_Terminate("tamuviplist.php");
		if ($Security->AllowList(CurrentProjectID() . 'parsys'))
			$this->Page_Terminate("parsyslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'vrekapbytype'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'vrekapbyvehicle'))
