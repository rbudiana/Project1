...
class cuser_add extends cuser {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$sFilterWrk = "";
			$sFilterWrk = $GLOBALS["user"]->AddParentUserIDFilter("", "");
	...
	function AddRow($rsold = NULL) {
		...
		if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
			$bValidParentUser = $Security->IsValidUserID($this->site->CurrentValue);
			if (!$bValidParentUser) {
				$sParentUserIdMsg = str_replace("%c", CurrentUserID(), $Language->Phrase("UnAuthorizedParentUserID"));
				$sParentUserIdMsg = str_replace("%p", $this->site->CurrentValue, $sParentUserIdMsg);
...
fuseradd.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fuseradd" id="fuseradd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="user">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_useradd" class="table table-bordered table-striped">
...
<input type="password" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="100"<?php echo $user->password->EditAttributes() ?>>
</span>
...
<?php } elseif (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$user->UserIDAllow("add")) { // Non system admin ?>
<span id="el_user_site" class="control-group">
<select data-field="x_site" id="x_site" name="x_site"<?php echo $user->site->EditAttributes() ?>>
<?php
if (is_array($user->site->EditValue)) {
...
<script type="text/javascript">
fuseradd.Lists["x_UserLevel"].Options = <?php echo (is_array($user->UserLevel->EditValue)) ? ew_ArrayToJson($user->UserLevel->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
