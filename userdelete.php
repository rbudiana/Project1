...
fuserdelete.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fuserdelete" id="fuserdelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_userdelete" class="ewTable ewTableSeparate">
<?php echo $user->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($user->id->Visible) { // id ?>
		<td><span id="elh_user_id" class="user_id"><?php echo $user->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($user->_userid->Visible) { // userid ?>
		<td><span id="elh_user__userid" class="user__userid"><?php echo $user->_userid->FldCaption() ?></span></td>
<?php } ?>
<?php if ($user->password->Visible) { // password ?>
		<td><span id="elh_user_password" class="user_password"><?php echo $user->password->FldCaption() ?></span></td>
<?php } ?>
<?php if ($user->site->Visible) { // site ?>
		<td><span id="elh_user_site" class="user_site"><?php echo $user->site->FldCaption() ?></span></td>
<?php } ?>
<?php if ($user->UserLevel->Visible) { // UserLevel ?>
		<td><span id="elh_user_UserLevel" class="user_UserLevel"><?php echo $user->UserLevel->FldCaption() ?></span></td>
<?php } ?>
<?php if ($user->_email->Visible) { // email ?>
		<td><span id="elh_user__email" class="user__email"><?php echo $user->_email->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_id" class="control-group user_id">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user__userid" class="control-group user__userid">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_password" class="control-group user_password">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_site" class="control-group user_site">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_UserLevel" class="control-group user_UserLevel">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user__email" class="control-group user__email">
