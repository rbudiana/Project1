...
class cuser extends cTable {
	...
	function __construct() {
		...
		// userid
		$this->_userid = new cField('user', 'user', 'x__userid', 'userid', '`userid`', '`userid`', 200, -1, FALSE, '`userid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// site
		$this->site = new cField('user', 'user', 'x_site', 'site', '`site`', '`site`', 200, -1, FALSE, '`site`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
   ...
   // Common render codes
	...
	function UserIDFilter($userid) {
		$sUserIDFilter = '`site` = ' . ew_QuotedValue($userid, EW_DATATYPE_STRING);
		$sParentUserIDFilter = '`site` IN (SELECT `site` FROM ' . "`user`" . ' WHERE `site` = ' . ew_QuotedValue($userid, EW_DATATYPE_STRING) . ')';
