...
?>
<form name="fuserlevelpermissionsadd" id="fuserlevelpermissionsadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($userlevelpermissions->userlevelid->PlaceHolder) ?>" value="<?php echo $userlevelpermissions->userlevelid->EditValue ?>"<?php echo $userlevelpermissions->userlevelid->EditAttributes() ?>>
</span>
