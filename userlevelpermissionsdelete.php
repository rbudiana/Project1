...
?>
<form name="fuserlevelpermissionsdelete" id="fuserlevelpermissionsdelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
		<td><span id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></span></td>
<?php } ?>
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
		<td><span id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename"><?php echo $userlevelpermissions->_tablename->FldCaption() ?></span></td>
<?php } ?>
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
		<td><span id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission"><?php echo $userlevelpermissions->permission->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $userlevelpermissions_delete->RowCnt ?>_userlevelpermissions_userlevelid" class="control-group userlevelpermissions_userlevelid">
...
<span id="el<?php echo $userlevelpermissions_delete->RowCnt ?>_userlevelpermissions__tablename" class="control-group userlevelpermissions__tablename">
...
<span id="el<?php echo $userlevelpermissions_delete->RowCnt ?>_userlevelpermissions_permission" class="control-group userlevelpermissions_permission">
