...
?>
<form name="fuserlevelpermissionsedit" id="fuserlevelpermissionsedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="userlevelpermissions">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_userlevelpermissionsedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" value="<?php echo ew_HtmlEncode($userlevelpermissions->userlevelid->CurrentValue) ?>">
...
<input type="hidden" data-field="x__tablename" name="x__tablename" id="x__tablename" value="<?php echo ew_HtmlEncode($userlevelpermissions->_tablename->CurrentValue) ?>">
