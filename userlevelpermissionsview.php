...
<?php if (!$userlevelpermissions_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fuserlevelpermissionsview" id="fuserlevelpermissionsview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="userlevelpermissions">
<table class="ewGrid"><tr><td>
<table id="tbl_userlevelpermissionsview" class="table table-bordered table-striped">
