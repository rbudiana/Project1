...
?>
<form name="fuserlevelsdelete" id="fuserlevelsdelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
		<td><span id="elh_userlevels_userlevelid" class="userlevels_userlevelid"><?php echo $userlevels->userlevelid->FldCaption() ?></span></td>
<?php } ?>
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
		<td><span id="elh_userlevels_userlevelname" class="userlevels_userlevelname"><?php echo $userlevels->userlevelname->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_userlevelid" class="control-group userlevels_userlevelid">
...
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_userlevelname" class="control-group userlevels_userlevelname">
