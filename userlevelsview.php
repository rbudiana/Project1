...
class cuserlevels_view extends cuserlevels {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_userlevels\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_userlevels',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fuserlevelsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<?php if (!$userlevels_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fuserlevelsview" id="fuserlevelsview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="userlevels">
<table class="ewGrid"><tr><td>
<table id="tbl_userlevelsview" class="table table-bordered table-striped">
