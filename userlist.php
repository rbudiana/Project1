...
class cuser_list extends cuser {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_user\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_user',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fuserlist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
fuserlist.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php if ($user_list->ExportOptions->Visible()) { ?>
<div class="ewListExportOptions"><?php $user_list->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php
	$bSelectLimit = EW_SELECT_LIMIT;
	if ($bSelectLimit) {
...
<form name="fuserlistsrch" id="fuserlistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<div class="accordion ewDisplayTable ewSearchTable" id="fuserlistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#fuserlistsrch_SearchGroup" href="#fuserlistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="fuserlistsrch_SearchBody" class="accordion-body collapse in">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($user_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $user_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
	</div>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($user_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($user_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($user_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($user_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $user_list->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($user_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($user_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $user_list->Pager->PageCount ?>
</td>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $user_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $user_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $user_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<?php } ?>
<form name="fuserlist" id="fuserlist" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="user">
...
<?php if ($user->id->Visible) { // id ?>
	<?php if ($user->SortUrl($user->id) == "") { ?>
		<td><div id="elh_user_id" class="user_id"><div class="ewTableHeaderCaption"><?php echo $user->id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->id) ?>',2);"><div id="elh_user_id" class="user_id">
...
<?php if ($user->_userid->Visible) { // userid ?>
	<?php if ($user->SortUrl($user->_userid) == "") { ?>
		<td><div id="elh_user__userid" class="user__userid"><div class="ewTableHeaderCaption"><?php echo $user->_userid->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->_userid) ?>',2);"><div id="elh_user__userid" class="user__userid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->_userid->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->_userid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->_userid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($user->password->Visible) { // password ?>
	<?php if ($user->SortUrl($user->password) == "") { ?>
		<td><div id="elh_user_password" class="user_password"><div class="ewTableHeaderCaption"><?php echo $user->password->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->password) ?>',2);"><div id="elh_user_password" class="user_password">
	...
	<?php } ?>
<?php } ?>		
<?php if ($user->site->Visible) { // site ?>
	<?php if ($user->SortUrl($user->site) == "") { ?>
		<td><div id="elh_user_site" class="user_site"><div class="ewTableHeaderCaption"><?php echo $user->site->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->site) ?>',2);"><div id="elh_user_site" class="user_site">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->site->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->site->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->site->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($user->UserLevel->Visible) { // UserLevel ?>
	<?php if ($user->SortUrl($user->UserLevel) == "") { ?>
		<td><div id="elh_user_UserLevel" class="user_UserLevel"><div class="ewTableHeaderCaption"><?php echo $user->UserLevel->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->UserLevel) ?>',2);"><div id="elh_user_UserLevel" class="user_UserLevel">
...
<?php if ($user->_email->Visible) { // email ?>
	<?php if ($user->SortUrl($user->_email) == "") { ?>
		<td><div id="elh_user__email" class="user__email"><div class="ewTableHeaderCaption"><?php echo $user->_email->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->_email) ?>',2);"><div id="elh_user__email" class="user__email">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->_email->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->_email->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->_email->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $user->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->site->Visible) { // site ?>
		<td<?php echo $user->site->CellAttributes() ?>>
<span<?php echo $user->site->ViewAttributes() ?>>
<?php echo $user->site->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($user->UserLevel->Visible) { // UserLevel ?>
