...
class cuser_view extends cuser {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_user\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_user',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fuserview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
fuserview.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!$user_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fuserview" id="fuserview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="user">
<table class="ewGrid"><tr><td>
<table id="tbl_userview" class="table table-bordered table-striped">
...
<?php echo $user->site->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
